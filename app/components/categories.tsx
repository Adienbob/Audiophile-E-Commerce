      ...
      <div className="categories">
         <div className="headphones">
            <picture>
               ...
               <img className="productImage" src="/assets/category-headphones/mobile/image-category-thumbnail-headphones.webp" alt="Image category thumbnail headphones" loading="lazy" decoding="async" />
            </picture>
         ...
         <div className="speakers">
            ...
            <img className="productImage" src="/assets/category-speakers/mobile/image-category-thumbnail-speakers.webp" alt="Image category thumbnail speakers" loading="lazy" decoding="async" />
            </picture>
         ...
         <div className="earphones">
            ...
            <img className="productImage" src="/assets/category-earphones/mobile/image-yx1-earphones.webp" alt="Image category thumbnail earphones" loading="lazy" decoding="async" />
            </picture>
