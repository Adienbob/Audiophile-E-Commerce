      ...
      <nav className="categories">
         <div className="headphones">
            <Image 
               ...
               src="/assets/category-headphones/mobile/image-category-thumbnail-headphones.webp" 
         ...
         <div className="speakers">
            <Image 
               className="productImage" 
               src="/assets/category-speakers/mobile/image-category-thumbnail-speakers.webp" 
               alt="Image category thumbnail earphones" 
               width={119} 
               height={116} 
               quality={100} 
         ...
         <div className="earphones">
            <Image 
               className="productImage" 
               src="/assets/category-earphones/mobile/image-yx1-earphones.webp" 
               alt="Image category thumbnail earphones" 
               width={119} 
               height={116} 
               quality={100} 
